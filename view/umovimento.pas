...
uses
  ...
  EditBtn, Buttons, DBGrids, ZDataset, rxcurredit, PReport, utabela, ucad_lcto,
  classe_conta, LR_Class, LR_DBSet, DB, LCLType, ComCtrls, ACBrEnterTab,
  upesquisa, uEstatistica_Despesa, upesquisa_lcto, importa, urel_movimento,
  ACBrUtil.Base;
